  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-disney-light-blue">
      <div className="bg-white dark:bg-neutral-800 p-8 rounded-lg border border-gray-200 w-full max-w-sm">
        ...
        <div className="mb-4">
          <label htmlFor="Username" className="block text-sm dark:text-gray-300 text-gray-600 mb-1">Username</label>
          <input
            type="text"
            id="Username"
        ...
        <div className="mb-4">
          <label htmlFor="Password" className="block dark:text-gray-300 text-sm text-gray-600 mb-1">Password</label>
          <input
            type="password" 
            id="Password"
        ...
        <p className="text-sm text-center dark:text-gray-300 text-gray-500 mt-4">
          ...
          <a href="/register" className="text-blue-600 dark:text-blue-400 hover:underline">Create one</a>
        </p>
