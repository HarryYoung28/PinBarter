...
export default function RegisterForm() {
    ...
    return (
        ...
        <div className="bg-white dark:bg-neutral-800 p-8 rounded-lg border border-gray-200 w-full max-w-sm">
            ...
            <div className="mb-4">
            <label htmlFor="Username" className="block text-sm text-gray-600 dark:text-gray-300 mb-1">Username</label>
            <input
                type="text"
                id="Username"
                ...
                ${usernameError ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"} text-gray-500`}
            />
            {usernameError && <p className="text-red-500 text-xs mt-1">{usernameError}</p>}
            </div>

            <div className="mb-4">
            <label htmlFor="Email" className="block text-sm dark:text-gray-300 text-gray-600 mb-1">Email</label>
            <input
                type="email"
                id="Email"
                placeholder="email"
                ...
                className={`w-full border dark:text-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 
                ${emailError ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"} text-gray-500`}
            />
            {emailError && <p className="text-red-500 text-xs mt-1">{emailError}</p>}
            </div>

            <div className="mb-4">
            <label htmlFor="Password" className="block text-sm dark:text-gray-300 text-gray-600 mb-1">Password</label>
            <input
                type="password"
                id="Password"
                ...
                className={`w-full border dark:text-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 
                ${passwordError ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"} text-gray-500`}
            />
